  ...
  <v-app id="inspire">
    <v-card-title>
      <v-toolbar dark class="elevation-2" color="cyan">
        <v-toolbar-title>vuetify-simple-date</v-toolbar-title>
      </v-toolbar>
    </v-card-title>
    <v-card-text>
      <v-container>
        ...
        <v-row>
          <v-col cols="4" sm="4" md="4">
            <VuetifySimpleDate v-model="value2" v-bind:label="label2" v-bind:options="options2" />
...
<script>
import VuetifySimpleDate from "./components/VuetifySimpleDate.vue";
